export const DEFAULT_CONTENT = {
    ...
    items: [
      {
        ...
        description:
          'From idea to deployment, we architect and build robust, scalable software tailored to your business needs. Web apps, APIs, mobile — we handle the full stack.',
      ...
      },
      {
        ...
        description:
          'We equip your teams with the right tools, frameworks, templates, and documentation to move faster and smarter. Think of us as your technical accelerator.',
      ...
      },
      {
        ...
        description:
          'Navigating the software ecosystem can be complex. Our consultants help you make the right architectural, tooling, and process decisions — every step of the way.',
  ...
  contact: {
    ...
    subheading:
      "Have a project in mind or just want to explore options? We'd love to hear from you.",
  ...
  footer: {
    ...
    copyright: '© 2025 Softbert Nexus Limited. All rights reserved.',
  },
};
